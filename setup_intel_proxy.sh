...
if [ "$?" -eq 0 ]; then
  ...
  sudo gsettings set org.gnome.system.proxy ignore-hosts "['localhost', '127.0.0.0/8', '*.local', 'intel.com', '*.intel.com', '10.0.0.0/8', '192.168.0.0/16', '134.134.0.0/16']"
  gsettings set org.gnome.system.proxy mode 'auto'
  gsettings set org.gnome.system.proxy autoconfig-url 'http://autoproxy.intel.com:9090'
  gsettings set org.gnome.system.proxy ignore-hosts "['localhost', '127.0.0.0/8', '*.local', 'intel.com', '*.intel.com', '10.0.0.0/8', '192.168.0.0/16', '134.134.0.0/16']"
fi
